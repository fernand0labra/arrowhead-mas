...
public class ProviderApplicationInitListener extends ApplicationInitListener {
	...
	protected void customInit(final ContextRefreshedEvent event) {
		...
		final ServiceRegistryRequestDTO getTemperatureServiceRequest = createServiceRegistryRequest(TemperatureProviderConstants.GET_TEMPERATURE_SERVICE_DEFINITION, TemperatureProviderConstants.TEMPERATURE_URI, HttpMethod.GET);
		getTemperatureServiceRequest.getMetadata().put(TemperatureProviderConstants.REQUEST_PARAM_KEY_UNIT, TemperatureProviderConstants.REQUEST_PARAM_UNIT);
		arrowheadService.forceRegisterServiceToServiceRegistry(getTemperatureServiceRequest);
	}
