...
public class OrchestrationFlags extends HashMap<String,Boolean> {
	...
	private static Map<String,Flag> initFlagMap() {
		...
		// mismatch-analysis
		result.put(CommonConstants.ORCHESTRATION_FLAG_ENABLE_MISMATCH_ANALYSIS, Flag.ENABLE_MISMATCH_ANALYSIS);
	...
	public enum Flag {
		...
		// mismatch-analysis
		ENABLE_MISMATCH_ANALYSIS(CommonConstants.ORCHESTRATION_FLAG_ENABLE_MISMATCH_ANALYSIS);
